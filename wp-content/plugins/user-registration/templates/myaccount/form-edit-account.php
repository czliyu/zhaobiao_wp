		...
		<div class="ur-form-row">
			<div class="ur-form-grid">
				...
				<p class="user-registration-form-row user-registration-form-row--first form-row form-row-first">
					<label for="account_first_name"><?php _e( '姓名', 'user-registration' ); ?> <span class="required">*</span></label>
					<input type="text" class="user-registration-Input user-registration-Input--text input-text" name="account_first_name" id="account_first_name" value="<?php echo esc_attr( $user->display_name ); ?>" />
				</p>
				<div class="clear"></div>

				<p class="user-registration-form-row user-registration-form-row--wide form-row form-row-wide">
					<label for="account_email"><?php _e( '邮箱地址', 'user-registration' ); ?> <span class="required">*</span></label>
				...
				<fieldset>
					<legend><?php _e( '修改密码', 'user-registration' ); ?></legend>

					<p class="user-registration-form-row user-registration-form-row--wide form-row form-row-wide">
						<label for="password_current"><?php _e( '当前密码', 'user-registration' ); ?></label>
					...
					<p class="user-registration-form-row user-registration-form-row--wide form-row form-row-wide">
						<label for="password_1"><?php _e( '新密码', 'user-registration' ); ?></label>
					...
					<p class="user-registration-form-row user-registration-form-row--wide form-row form-row-wide">
						<label for="password_2"><?php _e( '重复密码', 'user-registration' ); ?></label>
				...
				<p>
					...
					<input type="submit" class="user-registration-Button button" name="save_account_details" value="<?php esc_attr_e( '保存', 'user-registration' ); ?>" />
